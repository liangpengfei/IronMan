...
public class ApplicationActivity extends Activity implements ActionBar.TabListener {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        Toast.makeText(this,"ConfigurationChanged",Toast.LENGTH_LONG).show();
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return getString(R.string.title_security).toUpperCase(l);
                case 1:
                    return getString(R.string.title_app_manager).toUpperCase(l);
                case 2:
                    return getString(R.string.title_private_protect).toUpperCase(l);
                case 3:
                    return  getString(R.string.title_usually_function).toUpperCase(l);
            }
            return null;
        }
    }
